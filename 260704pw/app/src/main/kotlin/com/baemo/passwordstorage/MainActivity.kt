...
class MainActivity : Activity() {
    ...
    companion object {
        ...
        private val COLOR_BG = Color.rgb(241, 245, 249)
        private val COLOR_PANEL = Color.rgb(255, 255, 255)
        private val COLOR_HEADER = Color.rgb(31, 41, 55)
        private val COLOR_HEADER_TEXT = Color.rgb(255, 255, 255)
        private val COLOR_BORDER = Color.rgb(148, 163, 184)
        private val COLOR_PASSWORD = Color.rgb(219, 234, 254)
        private val COLOR_PASSWORD_REVEALED = Color.rgb(220, 252, 231)
        private val COLOR_RESET = Color.rgb(226, 232, 240)
        private val COLOR_TEXT = Color.rgb(17, 24, 39)
        private val COLOR_MUTED = Color.rgb(71, 85, 105)
