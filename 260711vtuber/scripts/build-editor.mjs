...
await Promise.all([
  ...
  build({
    ...shared,
    entryPoints: [path.join(editorSourceRoot, "audseg-worker.js")],
...
await Promise.all([
  ...
  copyFile(
    ...
    path.join(licenseRoot, "AUDSEG-MIT.txt")
  ),
  copyFile(
...
console.log(
  `Editor/AudSeg Worker/content bridge bundles, Pretendard ${PRETENDARD_FONT.version}, ` +
