...
export function evaluateCaptionCues(cues, {
  clipDurationMs,
  transcript,
  visualPlacement,
  editorialContext,
...
export const evaluateCaptionDraft = evaluateCaptionCues;
...
export function repairCaptionCues(rawCues, {
  clipDurationMs,
  transcript,
  visualPlacement,
  editorialContext,
  ...
  const evaluation = evaluateCaptionCues(finalizedCues, {
    clipDurationMs: duration,
...
export function repairCaptionDraft(rawCues, options) {
  const repaired = repairCaptionCues(rawCues, options);
