...
assert(editorHtml.includes('option value="audseg-local"'), "AudSeg 선택지가 없습니다.");
assert((editorHtml.match(/<option value="(?:whisper-tiny|audseg-local)"/gu) || []).length === 2, "자막 초벌 방식은 Whisper와 AudSeg 두 개여야 합니다.");
assert(editorHtml.includes('id="caption-advanced-settings"'), "로컬 Whisper companion 세부설정 접기가 없습니다.");
